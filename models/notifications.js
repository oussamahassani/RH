...
var NotificationSchema   = new Schema({
    sender: {type:mongoose.Schema.Types.ObjectId, ref:'users'}, // Notification creator
    receiver: [{type:mongoose.Schema.Types.ObjectId, ref:'users'}], // Ids of the receivers of the notification
    title: String,
