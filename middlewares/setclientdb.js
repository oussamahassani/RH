            ...
            function setclientdb() {
                return function (req, res, next) {
                    ...
                    //make new db connection
                        ...
                        console.log('setting db for client ' + req.subdomains[1] + ' and ' + req.session.Client.dbUrl);
                        client = mongoose.createConnection('mongodb+srv://devlopy:xdp.devlopy.db@xprtest-j2upz.mongodb.net/'+req.session.Client.dbUrl+'?retryWrites=true&w=majority' , { useNewUrlParser: true,  useUnifiedTopology: false });
